...
sent_barplot(comp_sent, 'comp_sent')
sent_barplot(p1_sent, 'p1_sent')
sent_barplot(p2_sent, 'p2_sent')
sent_barplot(p3_sent, 'p3_sent')
sent_barplot(p4_sent, 'p4_sent')
sent_barplot(p5_sent, 'p5_sent')
sent_barplot(p6_sent, 'p6_sent')
sent_barplot(p7_sent, 'p7_sent')
sent_barplot(p8_sent, 'p8_sent')
